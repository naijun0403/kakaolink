...
var CustomError = /** @class */ function (ErrorName) {
...
var KakaoLinkLoginError = CustomError('KakaoLinkLoginError'); //Login Error;

var CryptoError = CustomError('CryptoError'); //-484

var AccessError = CustomError('AccessError'); //-435

var ApiKeyError = CustomError('ApiKeyError'); //401

var KakaoLinkSendError = CustomError('KakaoLinkSendError');
